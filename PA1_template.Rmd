...
```
In order not to alter the average of each step in each interval, I consider that a good alternative is to replace the missing values with the average of each step in each interval.
